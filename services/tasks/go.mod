module github.com/tracehubmmp/golang-basics/services/tasks

go 1.27.0

replace github.com/tracehubmmp/golang-basics/libs/httpx => ../../libs/httpx

replace github.com/tracehubmmp/golang-basics/libs/pgx => ../../libs/pgx

replace github.com/tracehubmmp/golang-basics/libs/valkey => ../../libs/valkey

replace github.com/tracehubmmp/golang-basics/libs/kafka => ../../libs/kafka

replace github.com/tracehubmmp/golang-basics/libs/otelx => ../../libs/otelx
...
require (
	...
	github.com/tracehubmmp/golang-basics/libs/httpx v0.0.0-00010101000000-000000000000
